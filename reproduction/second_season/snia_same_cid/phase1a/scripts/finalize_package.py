#!/usr/bin/env python3
"""Write and verify manifests, then optionally build the delivery archive."""
...
def main() -> int:
    ...
    try:
        ...
        if args.check or args.archive:
            ...
            print(f"PASS: {result['manifested_file_count']} manifested files")
        if args.archive:
            archive_result = deterministic_archive(
