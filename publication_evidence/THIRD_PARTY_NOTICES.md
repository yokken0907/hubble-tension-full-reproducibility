...
The bundled `provenance/PHASE1B_ROW_MAP.tsv` is a project-created index/identifier crosswalk required for the same-name verification. It does not contain photometry, posterior samples, covariance values, or Hubble-diagram measurements.
...
The four version-locked archival project records are identified by filename and SHA-256 but are not embedded in this supplement. Their redistribution status is not enlarged or implied by this archive.
