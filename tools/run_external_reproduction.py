...
def main():
    ap = argparse.ArgumentParser(
        description='Run public-input reproductions in an isolated working copy so the fixed repository is never modified.'
    )
    ...
    try:
        ...
        # Same-name / covariance verification reads official public inputs directly.
        run([
            sys.executable,
